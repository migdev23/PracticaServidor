...
const duplicadoUsuario = (req, res, next) => {
    ...
    const existeUsuario = require('../models/db/db.js').find(usuario => usuario.email === req.body.email)
...
const existeUser = (req, res, next) => {
    ...
    const existeUsuario = require('../models/db/db.js').find(user => user.email === req.body.email)
...
const passwordAutenticada = async(req,res,next) => {
    ...
    const usuario = require('../models/db/db.js').find(usuario => usuario.email === req.body.email);
